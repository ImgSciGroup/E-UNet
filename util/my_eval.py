...
if __name__ == "__main__":
    ...
    TP, TN, FP, FN, c_num_or, uc_num_or= Indicators.ConfusionMatrix()
    nn=Index(TP, TN, FP, FN, c_num_or, uc_num_or)
    OA, Precision , Recall , F1=nn.ObjectExtract_indicators()
    OA1,kappa,AA=nn.Classification_indicators()
    Completeness, Correctness , Quality =nn.Landsilde_indicators()
    FA , MA , TE =nn.CD_indicators()
    print("OA:",OA,"   KAPPA:",kappa,"AA:", AA)
    print(" FA:", FA,"   MA:",MA,"TE:",TE)
    print("Completeness:",Completeness,"Correctness :",Correctness,"Quality:", Quality)
